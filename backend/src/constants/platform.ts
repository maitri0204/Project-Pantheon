...
export const DEFAULT_ASSESSMENTS: AssessmentSeedDefinition[] = [
  {
    ...
    summary: "MBTI-style personality assessment for students.",
  ...
  },
  {
    ...
    summary: "Domain-based metacognition assessment for students and parents.",
  ...
  },
  {
    ...
    summary: "Self-awareness assessment using Johari quadrant scoring.",
