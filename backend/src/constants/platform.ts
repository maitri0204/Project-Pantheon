...
export const DEFAULT_ASSESSMENTS: AssessmentSeedDefinition[] = [
  ...
  },
  {
    ...
    slug: "employability-quotient",
    name: "Employability Quotient",
    category: "employability",
    summary: "Measure employability readiness across 10 future-skills dimensions - analytical thinking, resilience, leadership, creativity, motivation, technology, empathy, curiosity, talent management, and service orientation.",
    sourceProject: "Project-Pantheon",
    sourceDbName: "employability_quotient",
    seedCommands: ["npm run seed:employability-quotient"],
    evaluationReference: "backend/src/services/employabilityQuotientScoring.service.ts#evaluateEmployabilityQuotientAnswers",
    reportReference: "frontend EmployabilityQuotientReport",
    invoiceReference: "Project-Centralized_System payment/invoice flow",
    loginReference: "OTP + math captcha auth flow",
    questionBankStatus: "imported",
    questionCount: 50,
    basePrice: 599,
    tags: ["employability", "student", "quotient"],
  },
];
