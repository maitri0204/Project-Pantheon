...
const orgAdminAllowedSuffixes = new Set(["", "/assessments", "/users"]);
...
export default function DashboardShell({
  ...
  useEffect(() => {
    ...
    const allowedPaths = [toHref(""), toHref("/assessments"), toHref("/users")];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="fixed top-0 left-0 right-0 z-50 h-[100px] bg-white border-b border-gray-200 flex items-center pl-7 pr-4 md:pl-25 gap-4 shadow-sm">
        <button
        ...
        <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-cyan-400 flex items-center justify-center text-white text-base font-bold shadow flex-shrink-0 mr-4">
      ...
      <aside
        className={`fixed top-[100px] left-0 z-40 h-[calc(100vh-100px)] w-64 bg-white border-r border-gray-200 flex flex-col shadow-sm transition-transform duration-300 ${
