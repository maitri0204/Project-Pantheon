    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-cyan-500 rounded-2xl p-7 text-white shadow-md">
        <div>
          ...
          <h1 className="text-3xl font-bold">Welcome back, {auth?.user.firstName}! 👋</h1>
          <p className="mt-2 text-blue-100 text-base">
            {role === "ORG_ADMIN"
              ? "Manage your assessments and students from one place."
              : "Manage all assessments, organizations, and whitelabel configurations from one place."}
          </p>
        </div>
      </div>
